...
- (id)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.opacity = 0.5;
        self.labelFont = [UIFont fontWithName:@"Helvetica" size:13.0];//[UIFont boldSystemFontOfSize:LABELFONTSIZE];
        self.detailsLabelFont = [UIFont fontWithName:@"Helvetica" size:11.0]; //[UIFont boldSystemFontOfSize:LABELDETAILSFONTSIZE]; 
        self.xOffset = 0.0;
        self.yOffset = 0.0;
		self.graceTime = 0.0;
    ...
    if (nil != self.labelText) {
        ...
        if (nil != self.detailsLabelText) {
            ...
            CGRect lFrameD = CGRectMake(floor((frame.size.width - lWidth) / 2) + xOffset,
                                        lFrame.origin.y + lFrame.size.height + PADDING - 43 , lWidth, lHeight + 100);
